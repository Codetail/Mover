...
public class RippleDrawable extends Drawable implements HotspotDrawable{
    ...
    public static RippleDrawable makeFor(View target, @ColorRes int color){
        return makeFor(target, target.getResources().getColorStateList(color), false);
    }

    public static RippleDrawable makeFor(View target, @ColorRes int color, boolean parentIsScrollContainer){
        return makeFor(target, target.getResources().getColorStateList(color), parentIsScrollContainer);
    }
