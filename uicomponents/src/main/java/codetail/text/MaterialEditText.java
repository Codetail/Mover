...
import codetail.text.validation.METValidator;
import codetail.utils.ColorUtils;
...
public class MaterialEditText extends EditText {
    ...
    private int getPixel(int dp) {
        return ResourceUtils.dp2px(getContext(), dp);
    }
    ...
    public boolean isCharactersCountValid() {
        ...
        return length >= minCharacters
                && (maxCharacters <= 0 || maxCharacters > length);
    }
