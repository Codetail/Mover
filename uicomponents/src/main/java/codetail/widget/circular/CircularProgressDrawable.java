...
import static codetail.widget.circular.CircularProgressBarUtils.checkAngle;
import static codetail.widget.circular.CircularProgressBarUtils.checkColors;
import static codetail.widget.circular.CircularProgressBarUtils.checkNotNull;
import static codetail.widget.circular.CircularProgressBarUtils.checkPositiveOrZero;
import static codetail.widget.circular.CircularProgressBarUtils.checkSpeed;
...
public class CircularProgressDrawable extends Drawable
  ...
  public static class Builder {
    ...
    private void initValues(Context context) {
      ...
      mSweepSpeed = 1f;
      mRotationSpeed = 1f;
      mColors = new int[]{ThemeUtils.getThemeColor(context, R.attr.colorPrimary)};
