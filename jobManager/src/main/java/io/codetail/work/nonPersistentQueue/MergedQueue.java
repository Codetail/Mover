package io.codetail.work.nonPersistentQueue;

import io.codetail.work.JobHolder;
...
abstract public class MergedQueue implements JobSet {
    ...
    /**
     *
     * @param initialCapacity passed to {@link io.codetail.work.nonPersistentQueue.MergedQueue#createQueue(io.codetail.work.nonPersistentQueue.MergedQueue.SetId, int, java.util.Comparator)}
     * @param comparator passed to {@link io.codetail.work.nonPersistentQueue.MergedQueue#createQueue(io.codetail.work.nonPersistentQueue.MergedQueue.SetId, int, java.util.Comparator)}
