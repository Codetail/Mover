package io.codetail.work.config;

import android.content.Context;
import android.net.ConnectivityManager;
import io.codetail.work.JobManager;
import io.codetail.work.JobQueue;
import io.codetail.work.QueueFactory;
import io.codetail.work.di.DependencyInjector;
import io.codetail.work.log.CustomLogger;
import io.codetail.work.network.NetworkUtil;
import io.codetail.work.network.NetworkUtilImpl;
import io.codetail.work.nonPersistentQueue.NonPersistentPriorityQueue;
import io.codetail.work.persistentQueue.sqlite.SqliteJobQueue;
...
public class Configuration {
    ...
    public static final class Builder {
        ...
        /**
         * By default, Job Manager comes with a simple {@link NetworkUtilImpl} that queries {@link android.net.ConnectivityManager}
