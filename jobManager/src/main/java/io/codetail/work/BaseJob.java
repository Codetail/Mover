...
abstract public class BaseJob implements Serializable {
    ...
    /**
     * before each run, JobManager sets this number. Might be useful for the {@link io.codetail.work.BaseJob#onRun()}
     * method
     * @return
     */
    ...
    /**
     * if job is set to require network, it will not be called unless {@link io.codetail.work.network.NetworkUtil}
