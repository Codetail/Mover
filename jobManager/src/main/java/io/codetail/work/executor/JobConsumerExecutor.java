package io.codetail.work.executor;
...
public class JobConsumerExecutor {
    ...
    /**
     * a simple {@link Runnable} that can take jobs from the {@link io.codetail.work.executor.JobConsumerExecutor.Contract} and execute them
     */
